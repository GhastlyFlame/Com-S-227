...
for i in range(0, for_range):
        os.system("java -jar galaxycommander.jar C:\\Users\\haadi\\Dropbox\\CS228hw4\\out\\production\\CS228_HW4\\cs228hw4\\game\\MyAgent.class edu.iastate.cs228.game.simulation.agent.RandomActionAgent random " + system_count + " -grading > test.txt")
        blue_count = 0
        red_count = 0
#        print(win_rate)
